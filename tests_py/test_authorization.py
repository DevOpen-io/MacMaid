...
@pytest.mark.parametrize("path", ["/api/clean", "/api/purge", "/api/analyze/trash", "/api/duplicates/trash", "/api/large-files/trash", "/api/smart-downloads/trash", "/api/apps/uninstall", "/api/developer/remove"])
