...
_TR: Final[dict[str, str]] = {
    ...
    "All ages": "Tüm yaşlar", "{days} days or older": "{days} gün veya daha eski", "included (manual review only)": "dahil (yalnızca elle inceleme)",
...
_TR_FRAGMENTS: Final[tuple[tuple[str, str], ...]] = tuple(sorted({
    ...
    "3.  Developer  [RECOMMENDED]": "3.  Geliştirici  [ÖNERİLEN]", "4.  Aggressive  [MAX CLEAN]": "4.  Agresif  [MAKSİMUM TEMİZLİK]",
    "1.  Storage Center": "1.  Depolama Merkezi", "2.  Runtimes & Languages": "2.  Çalışma Zamanları ve Diller",
    "3.  Environments": "3.  Ortamlar", "4.  Global CLI tools": "4.  Global CLI araçları",
    "5.  SDKs & simulators": "5.  SDK'lar ve simülatörler", "6.  Package-manager caches": "6.  Paket yöneticisi önbellekleri",
    "1.  Browser Storage": "1.  Tarayıcı Depolaması", "2.  Smart Downloads": "2.  Akıllı İndirmeler",
    "3.  Duplicate Files": "3.  Kopya Dosyalar", "4.  Large & Old Files": "4.  Büyük ve Eski Dosyalar",
    "1.  Leftovers": "1.  Kalıntılar", "2.  Installers": "2.  Yükleyiciler", "3.  Snapshots": "3.  Anlık Görüntüler",
    "4.  Doctor": "4.  Tanılama", "5.  Permissions": "5.  İzinler", "6.  Settings": "6.  Ayarlar",
    "7.  History": "7.  Geçmiş", "8.  Whitelist": "8.  Koruma Listesi",
    "1.  Install Update": "1.  Güncellemeyi Yükle", "2.  Check Again": "2.  Yeniden Denetle",
