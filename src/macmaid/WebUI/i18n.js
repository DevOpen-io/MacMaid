...
const I18N = {
  en: {
    ...
    "sidebar.search_aria": "Search MacMaid tools",
    "sidebar.search_empty": "No matching tools.",
    ...
    "clean.profile_safe_context": "Safe — low-risk caches only",
    "clean.profile_deep_context": "Deep — broader cache and log cleanup",
    "clean.profile_developer_context": "Developer — rebuildable development data",
    "clean.profile_aggressive_context": "Aggressive — expanded review required",
    ...
    "apps.empty_detail": "Select an application to view details.",
    ...
    "purge.detected_count": "({count} directories detected)",
    ...
    "status.state_na": "N/A",
    "clean.idle_title": "Ready when you are",
    "clean.idle_description": "Choose a profile and scan to review what can be cleaned. Nothing is removed during a scan.",
  ...
  tr: {
    ...
    "sidebar.search_placeholder": "Ara",
    "sidebar.search_aria": "MacMaid araçlarında ara",
    "sidebar.search_empty": "Eşleşen araç yok.",
    ...
    "clean.profile_safe_context": "Güvenli — yalnız düşük riskli önbellekler",
    "clean.profile_deep_context": "Derin — daha geniş önbellek ve günlük temizliği",
    "clean.profile_developer_context": "Geliştirici — yeniden üretilebilir geliştirme verileri",
    "clean.profile_aggressive_context": "Agresif — kapsamlı inceleme gerekir",
    ...
    "apps.empty_detail": "Ayrıntıları görüntülemek için bir uygulama seçin.",
    ...
    "purge.detected_count": "({count} dizin tespit edildi)",
    ...
    "clean.idle_title": "Hazır olduğunuzda başlayın",
    "clean.idle_description": "Bir profil seçip temizlenebilecek öğeleri incelemek için tarayın. Tarama sırasında hiçbir şey silinmez.",
...
const MEMORY_COPY = {
  title: ['Memory', 'Bellek'], nav: ['Applications & memory', 'Uygulamalar ve bellek'],
  ...
  metricHelp: ['About memory metrics', 'Bellek metrikleri hakkında'], summaryLabel: ['Memory summary', 'Bellek özeti'],
  monitoringShort: ['Monitoring while MacMaid runs', 'MacMaid çalışırken izleniyor'], processes: ['Processes', 'Süreçler'], searchPlaceholder: ['App, bundle, PID, or path', 'Uygulama, bundle, PID veya yol'],
  processSummary: ['{visible} of {total} processes · {protected} protected', '{total} süreçten {visible} tanesi · {protected} korumalı'], groupSummary: ['{visible} of {total} groups · {processes} processes · {protected} protected', '{total} gruptan {visible} tanesi · {processes} süreç · {protected} korumalı'], processCount: ['Processes', 'Süreçler'], growingCount: ['{count} showing sustained growth', '{count} süreç sürekli büyüyor'], protectedCount: ['{count} protected', '{count} korumalı'], systemWide: ['System-wide usage', 'Sistem genelindeki kullanım'],
  search: ['Search applications and processes', 'Uygulama ve süreç ara'], filter: ['Show', 'Göster'], all: ['All processes', 'Tüm süreçler'], developer: ['Developer tools', 'Geliştirici araçları'], flutter: ['Flutter / Dart', 'Flutter / Dart'], sort: ['Sort by', 'Sıralama'], rss: ['Resident memory (RSS)', 'Yerleşik bellek (RSS)'], growth: ['10-minute growth', '10 dakikalık büyüme'], cpu: ['CPU', 'CPU'], name: ['Application / Process', 'Uygulama / Süreç'], status: ['Status', 'Durum'], actions: ['Actions', 'İşlemler'], selection: ['Select', 'Seç'],
  memory: ['Memory', 'Bellek'], pidOrCount: ['PID / count', 'PID / sayı'], procCountSort: ['Process count', 'Süreç sayısı'], procCount: ['{count} processes', '{count} süreç'], filterApplications: ['Applications', 'Uygulamalar'], filterHigh: ['High memory', 'Yüksek bellek'],
  expandGroup: ['Show {count} processes', '{count} süreci göster'], collapseGroup: ['Hide processes', 'Süreçleri gizle'], selectGroup: ['Select eligible processes in group', 'Gruptaki uygun süreçleri seç'],
  metricFootprint: ['Physical footprint — shared pages counted once across the group', 'Fiziksel ayak izi — paylaşılan sayfalar grup genelinde bir kez sayılır'], metricRss: ['Combined RSS — shared pages counted per process', 'Birleşik RSS — paylaşılan sayfalar süreç başına sayılır'],
  groupMemory: ['Memory footprint', 'Bellek ayak izi'], rssTotal: ['Child RSS total', 'Alt süreç RSS toplamı'], rssTotalNote: ['Sum of process RSS values', 'Süreç RSS değerlerinin toplamı'], eligibility: ['Eligible to stop', 'Durdurulabilir'], groupEligible: ['{eligible} of {total} processes', '{total} süreçten {eligible} tanesi'], partialCoverage: ['Partial', 'Kısmi'],
  protectedAll: ['All protected', 'Tümü korumalı'], protectedInline: ['{count} protected', '{count} korumalı'], growingMulti: ['{count} processes growing', '{count} süreç büyüyor'], growingCountShort: ['{count} growing', '{count} büyüyor'],
  groupingNote: ['Applications are grouped into process families. A group’s memory is the macOS physical footprint measured across its processes; shared pages are counted once. Child rows show per-process RSS.', 'Uygulamalar süreç aileleri altında gruplanır. Grup belleği, süreçleri genelinde ölçülen macOS fiziksel ayak izidir; paylaşılan sayfalar bir kez sayılır. Alt satırlar süreç başına RSS gösterir.'],
